...
from src.model.cox_mil_resnet import CoxMaxResnet
...
def cross_val(folds=3):
    ...
    for fold in range(folds):
        ...
        model = CoxMaxResnet(resnet_params, maxmil_params).to(device)
        ...
        for epoch in range(NUM_EPOCHS):
            ...
            for traces, masks, durations, events in train_dataloader:
                ...
                if BATCH_SIZE > CHUNK_SIZE:
                    ...
                    for i in range(accumulation_steps):
                        ...
                        risks_chunk = model(traces_chunk, masks_chunk)
            ...
            with torch.no_grad():
                ...
                for val_traces, val_masks, val_durations, val_events in val_dataloader:
                    ...
                    val_risks = model(val_traces, val_masks)
