...
def cross_val(folds=3):
    ...
    for fold in range(1, folds + 1):
        ...
        log_dir = f"runs/cross_val_05_05/fold_{fold}"
    ...
    torch.save(model.state_dict(), f"/home/guest/lib/data/saved_models/cross_val_05_05_fold{fold}.pth")
